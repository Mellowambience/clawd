"""
Enhanced Wing Animation - More Pronounced Movement
"""
...
class PronouncedWingAnimation:
    def __init__(self):
        # Create a transparent window for the fairy
        self.root = tk.Tk()
        self.root.title("Pronounced Wing Animation")
    ...
    def draw_fairy(self):
        """Draw the fairy with pronounced wing animation"""
        ...
        # Draw organic wings (light lavender, semi-translucent) - MORE PRONOUNCED ANIMATION
        # Use the wing_phase to create animation with more visible movement
        wing_offset = math.sin(self.wing_phase) * 8  # Much more pronounced wing movement
        
        # Left wing - bigger for more dramatic effect
        left_wing_points = [
            draw_x - 55, draw_y - 20 + wing_offset,  # Bigger with more movement
            draw_x - 70, draw_y - 35,
            draw_x - 58, draw_y + 5,
            draw_x - 45, draw_y - 8
        ]
        ...
        right_wing_points = [
            draw_x + 55, draw_y - 20 - wing_offset,  # Bigger with more movement (opposite direction)
            draw_x + 70, draw_y - 35,
            draw_x + 58, draw_y + 5,
            draw_x + 45, draw_y - 8
        ]
    ...
    def animate(self):
        """Animate with pronounced wing movement"""
        # Handle blinking
        ...
        # Increment wing phase for animation (slower, more visible movement)
        self.wing_phase += 0.15  # Adjust this value to control speed
...
def main():
    print("Starting Pronounced Wing Animation...")
    print("Wings now have much more visible movement.")
    
    companion = PronouncedWingAnimation()
    companion.run()
