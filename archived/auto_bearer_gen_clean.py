...
def generate_bearer_token():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("[SUCCESS] Bearer Token added to configuration!")
            print()
            ...
            print(f"[ERROR] Failed to obtain Bearer Token. Status: {response.status_code}")
            print(f"Response: {response.text}")
            return False
            
    except Exception as e:
        print(f"[ERROR] Error obtaining Bearer Token: {e}")
        return False
